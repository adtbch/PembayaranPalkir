...
public class Main {
    ...
    public static void tampilkanBiaya(Kendaraan kendaraan) {
        ...
        System.out.println("Total palkir: " + kendaraan.getjamPalkir());
        System.out.println("Biaya palkir: Rp. " + kendaraan.hitungTotalBiaya());
    }
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);    
            ...
            while (!validInput) {
                try {
                    System.out.print("Masukan berapa jam waktu palkir : ");
                    jamPalkir = scanner.nextDouble();
        ...
        kendaraan.setjamPalkir(jamPalkir);
